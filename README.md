...
import clunkster.parse.tree as tree

CLUSTERABLE_ASSETS: tuple[AssetType, ...] = (
    AssetType.SPRITE, AssetType.BACKGROUND, AssetType.SOUND,
    AssetType.PATH, AssetType.SCRIPT, AssetType.FONT,
    AssetType.OBJECT, AssetType.ROOM
)
...
def main(project_path: str) -> None:
    ...
    # json.dumps gives better formatting than pprint
