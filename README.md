...
still add them - we'll be filling them in in this step, instead of
...
Also, notice that base implementation of Clunkster we load everything
synchronously and in one block, resulting in 1-5 second stutters during
