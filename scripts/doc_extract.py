        ...
        for child in node.children:
            ...
            if child.tag_name == 'snip':
                ...
                if inner_name in snippets or inner_name in snip_name_to_node:
                    raise ValueError(f"Duplicate inner snippet name: {inner_name}")
                ...
                for inner_child in child.children:
                    if isinstance(inner_child, NodeText):
                        ...
                        raise ValueError(
                            f"Depth limit exceeded in {inner_name}: Snippets can only be nested 1 level deep.")
                    else:
                        raise NotImplementedError(f"Tag <{inner_child.tag_name}> not implemented.")
                ...
                raise NotImplementedError(f"Tag <{child.tag_name}> not implemented.")
